...
public class BruteCollinearPoints {
	...
	private LineSegment[] initsegments(Point[] points2) {
		LineSegment[] segs = new LineSegment[N_LINE];
		int nbSegments = 0;
		for(int i = 0 ; i < N; i++){
			Point p1 = points[i];
			if(p1 == null) throw new IllegalArgumentException("Point is null");
...
//			System.out.println("p1: " + p1);
			for(int j = i+1; j < N; j++){
				Point p2 = points[j];
				if(p2 == null) throw new IllegalArgumentException("Point is null");
...
//				System.out.println("slope12: " + slope12);
				...
				for(int k = j+1; k < N; k++){
					Point p3 = points[k];
					if(p3 == null) throw new IllegalArgumentException("Point is null");
...
//					System.out.println("slope13: " + slope13);
					...
					for(int l = k+1; l < N; l++){
						Point p4 = points[l];
						if(p4 == null) throw new IllegalArgumentException("Point is null");
